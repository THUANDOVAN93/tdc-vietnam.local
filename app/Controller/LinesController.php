 ...
 */
class LinesController extends AdminController {
/**
 * paginate
 *
 * @var array
 ...
 */
    public function beforeFilter() {
        ...
        $this->set('title_for_layout', sprintf(Configure::read('Admin.Message.Title'), '路線管理'));
    }
    ...
    public function admin_add() {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Line->save($this->request->data)) {
                ...
                $validErrors = $this->Line->validationErrors;
 ...
 */
    public function admin_delete($id = null) {
        ...
        try {
            $result = $this->Line->delete();
        } catch (PDOException $e) {
            $result = false;
            if ($e->getCode() == Configure::read('MySql.ErrorCode.ForeignKey')) {
                $data = $this->Line->read('name');
                $dataName = $data['Line']['name'];
