...
/**
 * FactorySubCategories Controller
 *
 * @property FactorySubCategory $FactorySubCategory
 */
class FactorySubCategoriesController extends AdminController {
/**
 * paginate
 *
 * @var array
 ...
 * @var array
 */
    public $uses = array('FactorySubCategory');
 ...
 */
    public function beforeFilter() {
        ...
        $this->set('title_for_layout', sprintf(Configure::read('Admin.Message.Title'), '区画種別管理'));
    }
 ...
 */
    public function admin_index() {
        $this->FactorySubCategory->recursive = 0;
        $this->set('factorySubCategories', $this->paginate());
    }
 ...
 */
    public function admin_add() {
        ...
        if ($this->request->is('post')) {
            ...
            $this->FactorySubCategory->create();

            if ($this->FactorySubCategory->save($this->request->data)) {
                $this->Session->setFlash(Configure::read('Admin.Message.DbUpdateSuccess'), 'default', array('class' => 'alert alert-success'));
                $this->redirect(array('action' => 'index'));
            } else {
                $validErrors = $this->FactorySubCategory->validationErrors;
 ...
 */
    public function admin_edit($id = null) {
        ...
        $this->FactorySubCategory->id = $id;
        if (!$this->FactorySubCategory->exists()) {
        ...
        if ($this->request->is('post') || $this->request->is('put')) {
            ...
            $this->request->data = $this->FactorySubCategory->read(null, $id);
        }
    }
 ...
 */
    public function admin_delete($id = null) {
        ...
        try {
            $result = $this->FactorySubCategory->delete();
        } catch (PDOException $e) {
            $result = false;
            if ($e->getCode() == Configure::read('MySql.ErrorCode.ForeignKey')) {
                $data = $this->FactorySubCategory->read('name');
                $dataName = $data['FactorySubCategory']['name'];
