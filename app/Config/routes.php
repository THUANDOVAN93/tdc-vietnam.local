 ...
 */
	...
	Router::connect(
		'/residence/area/',
		array(
			'controller' => 'FrontResidence',
			'action' => 'area_index'
		)
	);

	Router::connect(
		'/residence/area/list/:areaId/*',
		array(
			'controller' => 'FrontResidence',
			'action' => 'area_list'
		)
	...
	Router::connect(
		'/residence/area/hanoi/list/:areaId/*',
		array(
			'controller' => 'FrontResidence',
			'action' => 'area_hanoi_list'
		)
	);
	...
	Router::connect(
		...
		array(
			'controller' => 'FrontResidence',
			'action' => 'station_index'
		)
	);

	Router::connect(
		'/residence/station/list/:stationId/*',
		array(
			'controller' => 'FrontResidence',
			'action' => 'station_list'
		)
