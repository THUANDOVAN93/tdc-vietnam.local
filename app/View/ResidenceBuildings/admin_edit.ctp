...
<div class="container">
	...
	<ul class="nav nav-tabs">
		...
		<li class="active"><a><?php __h('住居物件の編集'); ?></a></li>
	</ul>
...
<?php } ?><span class="label label-important label-comment"><?php __h('キッチンと洗濯機はサービスアパートのみ入力内容が表示されます'); ?></span>
						</div>
					</td>
				</tr>
				<tr>
...
<?php $num = 0; ?>
							...
							<div>
<?php if (isset($residenceData['ResidencePhoto'][$num]['path'])) { ?>
								<div class="image_display">
									<p class="image_link"><a href="<?php echo Configure::read('UploadDir') . $this->name; ?>/tmb_list_<?php echo $residenceData['ResidencePhoto'][$num]['path']; ?>" target="_blank">Image</a></p>
									<?php echo $this->Form->hidden('ResidencePhoto.' . $num . '.path_hidden', array('value'=>$residenceData['ResidencePhoto'][$num]['path'])); ?>
									<label class="delete_label" for="ResidencePhoto<?php echo $num; ?>PathDelete">
										<?php echo $this->Form->checkbox('ResidencePhoto.' . $num . '.path_delete'); ?>
										<?php __h('画像を削除する'); ?>
									</label>
								</div>
<?php } else { ?>
...
<?php if (isset($residenceData['ResidencePhoto'][$num]['path'])) { ?>
								<div class="image_display">
									<p class="image_link"><a href="<?php echo Configure::read('UploadDir') . $this->name; ?>/tmb_main_<?php echo $residenceData['ResidencePhoto'][$num]['path']; ?>" target="_blank">Image</a></p>
									<?php echo $this->Form->hidden('ResidencePhoto.' . $num . '.path_hidden', array('value'=>$residenceData['ResidencePhoto'][$num]['path'])); ?>
									<label class="delete_label" for="ResidencePhoto<?php echo $num; ?>PathDelete">
										<?php echo $this->Form->checkbox('ResidencePhoto.' . $num . '.path_delete'); ?>
										<?php __h('画像を削除する'); ?>
...
<?php if (isset($residenceData['ResidencePhoto'][$num]['path'])) { ?>
								<div class="image_display">
									<p class="image_link"><a href="<?php echo Configure::read('UploadDir') . $this->name; ?>/tmb_sub_<?php echo $residenceData['ResidencePhoto'][$num]['path']; ?>" target="_blank">Image</a></p>
									<?php echo $this->Form->hidden('ResidencePhoto.' . $num . '.path_hidden', array('value'=>$residenceData['ResidencePhoto'][$num]['path'])); ?>
									<label class="delete_label" for="ResidencePhoto<?php echo $num; ?>PathDelete">
										<?php echo $this->Form->checkbox('ResidencePhoto.' . $num . '.path_delete'); ?>
										<?php __h('画像を削除する'); ?>
...
<?php if (isset($residenceData['ResidencePhoto'][$num]['path'])) { ?>
								<div class="image_display">
									<p class="image_link"><a href="<?php echo Configure::read('UploadDir') . $this->name; ?>/tmb_subsub_<?php echo $residenceData['ResidencePhoto'][$num]['path']; ?>" target="_blank">Image</a></p>
									<?php echo $this->Form->hidden('ResidencePhoto.' . $num . '.path_hidden', array('value'=>$residenceData['ResidencePhoto'][$num]['path'])); ?>
									<label class="delete_label" for="ResidencePhoto<?php echo $num; ?>PathDelete">
										<?php echo $this->Form->checkbox('ResidencePhoto.' . $num . '.path_delete'); ?>
										<?php __h('画像を削除する'); ?>
