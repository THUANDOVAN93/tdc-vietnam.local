...
<div class="row-fluid">
	...
	<ul class="nav nav-tabs">
		<li><a href="<?php echo $this->webroot; ?>admin/areas"><?php __h('エリア一覧'); ?></a></li>
		<li class="active"><a href="<?php echo $this->webroot; ?>admin/areas/add"><?php __h('エリアの追加'); ?></a></li>
		<li class="disabled"><a><?php __h('エリアの編集'); ?></a></li>
	</ul>

	<?php echo $this->Form->create('Area', array('enctype' => 'multipart/form-data', 'class' => 'form-horizontal')); ?>
		<fieldset>
			<table class="table-input">
				<tr>
					<th><?php __h('エリア名'); ?><span class="label label-important require-s"><?php __h('必須'); ?></span></th>
