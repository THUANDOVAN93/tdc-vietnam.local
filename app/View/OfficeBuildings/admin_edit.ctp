...
<div class="container">
	...
	<ul class="nav nav-tabs">
		...
		<li class="active"><a><?php __h('事務所物件の編集'); ?></a></li>
	</ul>
...
<?php } ?>
				...
				<tr>
					...
					<td>
						<div class="input-append">
						<?php echo $this->Form->text('parking', array('class'=>'span2','value'=>number_format(str_replace(',','', $this->Form->value('parking'))))); ?>
...
<?php } ?>
				...
				<tr>
					...
					<td>
						<div class="input-append">
							<?php echo $this->Form->text('management_cost', array('value' => number_format( str_replace( ',', '', $this->Form->value('management_cost') ), 1 ) ) ); ?>
...
<?php $num = 0; ?>
							...
							<div>
<?php if (isset($officeData['OfficePhoto'][$num]['path'])) { ?>
								<div class="image_display">
									<p class="image_link"><a href="<?php echo Configure::read('UploadDir') . $this->name; ?>/tmb_list_<?php echo $officeData['OfficePhoto'][$num]['path']; ?>" target="_blank">Image</a></p>
									<?php echo $this->Form->hidden('OfficePhoto.' . $num . '.path_hidden', array('value'=>$officeData['OfficePhoto'][$num]['path'])); ?>
									<label class="delete_label" for="OfficePhoto<?php echo $num; ?>PathDelete">
										<?php echo $this->Form->checkbox('OfficePhoto.' . $num . '.path_delete'); ?>
										<?php __h('画像を削除する'); ?>
									</label>
								</div>
<?php } else { ?>
...
<?php if (isset($officeData['OfficePhoto'][$num]['path'])) { ?>
								<div class="image_display">
									<p class="image_link"><a href="<?php echo Configure::read('UploadDir') . $this->name; ?>/tmb_main_<?php echo $officeData['OfficePhoto'][$num]['path']; ?>" target="_blank">Image</a></p>
									<?php echo $this->Form->hidden('OfficePhoto.' . $num . '.path_hidden', array('value'=>$officeData['OfficePhoto'][$num]['path'])); ?>
									<label class="delete_label" for="OfficePhoto<?php echo $num; ?>PathDelete">
										<?php echo $this->Form->checkbox('OfficePhoto.' . $num . '.path_delete'); ?>
										<?php __h('画像を削除する'); ?>
...
<?php if (isset($officeData['OfficePhoto'][$num]['path'])) { ?>
								<div class="image_display">
									<p class="image_link"><a href="<?php echo Configure::read('UploadDir') . $this->name; ?>/tmb_sub_<?php echo $officeData['OfficePhoto'][$num]['path']; ?>" target="_blank">Image</a></p>
									<?php echo $this->Form->hidden('OfficePhoto.' . $num . '.path_hidden', array('value'=>$officeData['OfficePhoto'][$num]['path'])); ?>
									<label class="delete_label" for="OfficePhoto<?php echo $num; ?>PathDelete">
										<?php echo $this->Form->checkbox('OfficePhoto.' . $num . '.path_delete'); ?>
										<?php __h('画像を削除する'); ?>
...
<?php if (isset($officeData['OfficePhoto'][$num]['path'])) { ?>
								<div class="image_display">
									<p class="image_link"><a href="<?php echo Configure::read('UploadDir') . $this->name; ?>/tmb_subsub_<?php echo $officeData['OfficePhoto'][$num]['path']; ?>" target="_blank">Image</a></p>
									<?php echo $this->Form->hidden('OfficePhoto.' . $num . '.path_hidden', array('value'=>$officeData['OfficePhoto'][$num]['path'])); ?>
									<label class="delete_label" for="OfficePhoto<?php echo $num; ?>PathDelete">
										<?php echo $this->Form->checkbox('OfficePhoto.' . $num . '.path_delete'); ?>
										<?php __h('画像を削除する'); ?>
...
<?php } ?>
							...
							<div>
								<label class="label-caption" for="OfficePhoto<?php echo $num; ?>Caption">キャプション</label>
								<div class="controls-caption">
									<?php echo $this->Form->text('OfficePhoto.' . $num . '.caption', array('class'=>'span5')); ?>
<?php $err = isset($validErrors['OfficePhoto'][$num]['caption'][0]);?>
<?php if ($err) { ?>
