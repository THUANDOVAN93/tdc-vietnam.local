<div class="container">
	...
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="<?php echo $this->webroot; ?>admin/office_properties/add"><?php __h('事務所部屋の追加'); ?></a></li>
...
<?php if (!empty($set_building_id)) { ?>
						<?php echo $this->Form->hidden('office_building_id', array('value'=>$set_building_id)); ?>
						<p class="build_text"><?php echo $officeBuildings[$set_building_id]; ?></p>
<?php } else { ?>
