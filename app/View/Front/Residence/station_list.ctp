...
<script type="text/javascript" src="<?php echo $this->webroot; ?>common/js/list.js"></script>
		...
		<div class="search_header clearfix">
			...
			<ul class="imgbtn clearfix">
				<li><a href="<?php echo $this->webroot; ?>office/station/"><img src="<?php echo $this->webroot; ?>common/images/search/header_nav01.png" width="160" height="40" alt="事務所を探す" /></a></li>
				<li><a href="<?php echo $this->webroot; ?>residence/station/"><img src="<?php echo $this->webroot; ?>common/images/search/header_nav02_on.png" width="160" height="40" alt="住まいを探す" /></a></li>
			</ul>
		</div>
		<!-- /search_header -->
		...
		<?php echo $this->Form->hidden('detail_url', array('id'=>'detail_url', 'value'=>$this->webroot . 'residence/station/detail/')); ?>
...
<?php } ?>
		...
		<?php echo $this->Form->create('ResidenceBuilding', array('url' => '/residence/station/list/' . $station['Station']['id'], 'id' => 'U_ResidenceBuildingStationListForm')); ?>
			<!-- search_nav/ -->
...
<?php foreach ($residenceBuildings as $residenceBuilding) { ?>
		...
		<div class="search_column_ttl clearfix">
			<h3><a href="<?php echo $this->webroot; ?>residence/station/detail/<?php echo h($residenceBuilding['ResidenceBuilding']['id']); ?>"><?php echo h($residenceBuilding['ResidenceBuilding']['name']); ?></a></h3>
			<p>
...
<?php     } ?>
			...
			<div class="search_column_section">
				...
				<col width="">
					...
					<tr>
						<th>エリア</th>
						<td><?php echo h($areas[$residenceBuilding['ResidenceBuilding']['area_id']]); ?></td>
					</tr>
					<tr>
...
<?php     } ?>
				...
				<p class="imgbtn"><a href="<?php echo $this->webroot; ?>residence/station/detail/<?php echo h($residenceBuilding['ResidenceBuilding']['id']); ?>"><img src="<?php echo $this->webroot; ?>common/images/search/search_column_btn01.png" width="180" height="30" alt="物件の詳細を見る" /></a></p>
			</div>
		</div>
<?php } ?>
...
<?php echo $this->element('paging'); ?>
		...
		<?php echo $this->Form->create('ResidenceBuilding', array('url' => '/residence/station/list/' . $station['Station']['id'], 'id' => 'B_ResidenceBuildingStationListForm')); ?>
			<!-- search_nav/ -->
			<div class="search_nav clearfix">
				<h4 class="imgbtn"><img src="<?php echo $this->webroot; ?>common/images/search/search_nav_btn01.png" width="230" height="48" alt="条件を絞り込んで検索" /></h4>
				<div class="search_nav_detail">
