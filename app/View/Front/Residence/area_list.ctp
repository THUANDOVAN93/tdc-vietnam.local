...
<script type="text/javascript" src="<?php echo $this->webroot; ?>common/js/list.js"></script>
		...
		<?php echo $this->Form->create('ResidenceBuilding', array('url' => '/residence/area/list/' . $area['Area']['id'], 'id' => 'U_ResidenceBuildingAreaListForm')); ?>
			<!-- search_nav/ -->
...
<?php foreach ($residenceBuildings as $residenceBuilding) { ?>
		...
		<div class="search_column_ttl clearfix">
			<h3><a href="<?php echo $this->webroot; ?>residence/area/detail/<?php echo h($residenceBuilding['ResidenceBuilding']['id']); ?>"><?php echo h($residenceBuilding['ResidenceBuilding']['name']); ?></a></h3>
			<p>
...
<?php     } ?>
				...
				<p class="imgbtn"><a href="<?php echo $this->webroot; ?>residence/area/detail/<?php echo h($residenceBuilding['ResidenceBuilding']['id']); ?>"><img src="<?php echo $this->webroot; ?>common/images/search/search_column_btn01.png" width="180" height="30" alt="物件の詳細を見る" /></a></p>
			</div>
		</div>
<?php } ?>
...
<?php echo $this->element('paging'); ?>
		...
		<?php echo $this->Form->create('ResidenceBuilding', array('url' => '/residence/area/list/' . $area['Area']['id'], 'id' => 'B_ResidenceBuildingAreaListForm')); ?>
			<!-- search_nav/ -->
			<div class="search_nav clearfix">
				<h4 class="imgbtn"><img src="<?php echo $this->webroot; ?>common/images/search/search_nav_btn01.png" width="230" height="48" alt="条件を絞り込んで検索" /></h4>
				<div class="search_nav_detail">
