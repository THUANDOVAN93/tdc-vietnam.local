...
<script type="text/javascript" src="<?php echo $this->webroot; ?>common/js/list.js"></script>
		...
		<ul id="topicpath">
			...
			<li><a href="<?php echo $this->webroot; ?>office/area/hanoi/">ハノイで探す</a></li>
		...
		<?php echo $this->Form->create('OfficeBuilding', array('url' => '/office/area/hanoi/list/' . $area['Area']['id'], 'id' => 'U_OfficeBuildingAreaListForm')); ?>
			<!-- search_nav/ -->
...
<?php foreach ($officeBuildings as $officeBuilding) { ?>
		...
		<div class="search_column_ttl clearfix">
			<h3><a href="<?php echo $this->webroot; ?>office/area/detail/<?php echo h($officeBuilding['OfficeBuilding']['id']); ?>?area=hanoi"><?php echo h($officeBuilding['OfficeBuilding']['name']); ?></a></h3>
			<p>
...
<?php     } ?>
				...
				<p class="imgbtn"><a href="<?php echo $this->webroot; ?>office/area/detail/<?php echo h($officeBuilding['OfficeBuilding']['id']); ?>?area=hanoi"><img src="<?php echo $this->webroot; ?>common/images/search/search_column_btn01.png" width="180" height="30" alt="物件の詳細を見る" /></a></p>
			</div>
		</div>
<?php } ?>
...
<?php echo $this->element('paging'); ?>
		...
		<?php echo $this->Form->create('OfficeBuilding', array('url' => '/office/area/hanoi/list/' . $area['Area']['id'], 'id' => 'B_OfficeBuildingAreaListForm')); ?>
			<!-- search_nav/ -->
			<div class="search_nav clearfix">
