...
<?php if (isset($officeBuilding['OfficeBuilding']['height']) && !empty($officeBuilding['OfficeBuilding']['height'])) { ?>
							<?php echo h($this->Common->doubleVal($officeBuilding['OfficeBuilding']['height'])); ?>m
<?php } else { ?>
							&nbsp;
<?php } ?>
						</td>
...
<?php     if (isset($officeBuilding['OfficeBuilding']['parking']) && !empty($officeBuilding['OfficeBuilding']['parking'])) { ?>
						<?php echo number_format(h($officeBuilding['OfficeBuilding']['parking'])); ?>&nbsp;VND/台
<?php     } else { ?>
						&nbsp;
<?php     } ?>
					</td>
...
<?php         if (isset($officeBuilding['OfficeBuilding']['management_cost']) && !empty($officeBuilding['OfficeBuilding']['management_cost'])) { ?>
						<?php echo h(number_format($officeBuilding['OfficeBuilding']['management_cost'], 1)); ?>&nbsp;USD/m&sup2;
<?php         } else { ?>
						&nbsp;
<?php         } ?>
					</td>
...
<?php     foreach($officeBuilding['OfficeProperty'][2] as $officeBuildingSale) { ?>
				<tr>
					...
					<td><?php echo h($this->Common->doubleVal($officeBuildingSale['floor_space'])); ?>m&sup2;</td>
					<td><?php echo h(number_format($officeBuildingSale['price'])); ?></td>
					<td class="note">
...
<?php     foreach($officeBuilding['OfficeProperty'][1] as $officeBuildingRent) { ?>
				<tr>
					...
					<td><?php echo h($this->Common->doubleVal($officeBuildingRent['floor_space'])); ?>m&sup2;</td>
					<td><?php echo h(number_format($officeBuildingRent['price'])); ?></td>
					<td class="note">
