<div class="container">
	...
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="<?php echo $this->webroot; ?>admin/factory_properties/add"><?php __h('工場区画の追加'); ?></a></li>
...
<?php if (!empty($set_building_id)) { ?>
						<?php echo $this->Form->hidden('factory_building_id', array('value'=>$set_building_id)); ?>
						<p class="build_text"><?php __h($factoryBuildings[$set_building_id]); ?></p>
<?php } else { ?>
...
<?php } ?>
				...
				<tr>
					...
					<td>
						<div class="input-append">
							<?php echo $this->Form->text('site_area', array()); ?>
							<span class="add-on">m&sup2;</span>
						</div>
...
<?php } ?>
				...
				<tr>
					<th><?php __h('位置図'); ?></th>
					<td>
						<?php echo $this->Form->file('arrangement_plan', array()); ?>
