...
$(document).ready(function(){
	...
	var stationUrl       = $('#station_url').val();
		...
		function attachMessage(marker, obj) {
			google.maps.event.addListener(marker, 'click', function(event) {
				...
				if ( obj.caption != 'station' ) { 
					...
					html[0] = '<a href="' + stationUrl + obj.id + '" target="blank">' + obj.name + '</a>';
					if (obj.photo != '') {
						html[1] = '<br /><a href="' + stationUrl + obj.id + '" target="blank"><img src="' + imagePath + 'tmb_list_' + obj.photo + '"></a>';
					}
				}
